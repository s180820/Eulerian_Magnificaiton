...
class compressor:
    def __init__(self):
        None
    def cut_video(self, video_file, start_time, end_time, output_file):
        command = "ffmpeg -i {} -ss {} -to {} -c copy {}".format(
            video_file, start_time, end_time, output_file)
        subprocess.call(command, shell=True)

    def compress_video(self, video_file, output_file):
    ...
    def cut_video_into_clips(self, video_file, output_dir):
