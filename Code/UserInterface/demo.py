...
def demo():
    ...
    st.write(
        """This demo is to show the Eulerian Video Magnification algorithm in action. It uses 
    ...
    stats_df_des = stats_df_des.rename(
    ...
    while cap2.isOpened():
        ...
        with placeholder2.container():
            ...
            with fig_col2:
                ...
                stats_df_des["MAE"] = [
                    np.abs(
                        stats_df["Ground Truth"]
                        - plot_df[plot_df["type"] == "Eulerian"]["BPM"]
                    ).mean(),
            ...
            fig = px.line(
                plot_df[plot_df["Time"].astype(int) > 6],
                x="Time",
                y="BPM",
                color="type",
                labels={"x": "Time", "y": "BPM"},
